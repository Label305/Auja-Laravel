...
class AujaConfiguratorSpec extends ObjectBehavior {
    ...
    function it_can_return_a_single_model() {
        ...
        $this->getModel('spec\Label305\AujaLaravel\Config\Club')->shouldHaveType('Label305\AujaLaravel\Config\Model');
    }
    ...
    function it_can_return_a_models_display_field(Model $model) {
        $this->configureClubConfigStubs();
        $this->configure(['spec\Label305\AujaLaravel\Config\Club']);
        $model->getName()->willReturn('spec\Label305\AujaLaravel\Config\Club');
